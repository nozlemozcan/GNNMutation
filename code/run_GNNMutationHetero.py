...
features_file = main_folder+"xfullgene_bm25_tfrf_breast.csv"            # input features file
ppi_file = main_folder+"ppi_network_pyhsical_String_breast.txt"         # input ppi edges file
pg_file = main_folder+"pg_network_breast_max300.csv"                    # input patient-protein edges file
print(features_file)
model_selection = "gat"
